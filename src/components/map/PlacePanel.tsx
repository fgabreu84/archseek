...
export default function PlacePanel({ place, isLocked, onClose }: PlacePanelProps) {
  return (
    <div className="absolute bottom-0 left-0 right-0 h-[58%] w-full sm:bottom-auto sm:top-0 sm:right-0 sm:left-auto sm:h-full sm:w-80 bg-white border-t border-neutral-200 sm:border-t-0 sm:border-l shadow-xl flex flex-col z-10 animate-slide-in">
      {/* Header */}
